...
- - - - - [x] Exercise: 3 stars, standard, optional (lookup_relate)
- - - - - [x] Exercise: 3 stars, standard, optional (insert_relate)
- - - [x] An Alternative Abstraction Relation (Optional, Advanced)
- - - - - [x] Exercise: 2 stars, standard, optional (union_collapse)
- - - - - [x] Exercise: 3 stars, standard, optional (union_update)
- - - - - [x] Exercise: 3 stars, advanced, optional (map_of_tree_prop)
- - - - - [x] Exercise: 3 stars, advanced, optional (bound_relate')
- - - - - [x] Exercise: 3 stars, advanced, optional (lookup_relate')
